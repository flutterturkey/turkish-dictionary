              ...
              child: FlatButton(
                ...
                child: Text('Vazgeç',
                  style: TextStyle(
                    ...
                    fontSize: 14.0,letterSpacing: 0.002,
                  )
                          ...
                          itemBuilder: (BuildContext ctx, int index) => Row(
                            ...
                            children: <Widget>[
                              Padding(
                                ...
                                child: Text(vowels[index],style: Theme.of(context).textTheme.body2.copyWith(letterSpacing: 0.2),),
                              ),
                            ],
                          ),
                        ),
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                Padding(
                                  ...
                                  child: Text('kalem', style: Theme.of(context).textTheme.body2.copyWith(color: AppConstant.colorHeading),),
                                )
                              ],
                            ),
                          ),
